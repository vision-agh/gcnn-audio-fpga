...
num_channels = cfg.general.num_channels

# Generate edge_index and features
edge_gen = edge_generator.EdgeGenerator(cfg.general.num_channels, 
                                                cfg.graph.channel_radius, 
                                                cfg.graph.time_radius, 
                                                cfg.general.time_window, 
                                                cfg.graph.skip_channels, 
                                                cfg.graph.features)
...
data['pos'][:, 0] = data['pos'][:, 0] / time_window
data['pos'][:, 1] = data['pos'][:, 1] / num_channels
