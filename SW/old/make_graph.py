...
parser.add_argument("--out_dir", type=str, default="graphs_hw_modified", help="Output directory")
parser.add_argument("--raw_data", type=str, default="./hdspikes", help="Data folder path")
...
def create_digraph_from_points(sparse_spikes, time_radius, channel_radius):
    ...
    for i in range(n):
        ...
        event_channel = int(sparse_spikes[i][1] * NUM_CHANNELS)  # Event channel (integerized)
